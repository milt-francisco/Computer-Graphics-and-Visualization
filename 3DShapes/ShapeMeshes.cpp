...
//	DrawBoxFacesMesh()
//
//	Transform and draw each individual face 
//	mesh to the window.
// 
///////////////////////////////////////////////////
void ShapeMeshes::DrawBoxFacesMesh(
	bool bDrawBack,
	bool bDrawBottom,
	bool bDrawLeft,
	bool bDrawRight,
	...
	bool bDrawFront) 
{
	...
	if (bDrawBack) glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(0 * sizeof(unsigned int)));
	if (bDrawBottom) glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(6 * sizeof(unsigned int)));
	if (bDrawLeft) glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(12 * sizeof(unsigned int)));
	if (bDrawRight) glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(18 * sizeof(unsigned int)));
	if (bDrawTop) glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(24 * sizeof(unsigned int)));
	if (bDrawFront) glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, (void*)(30 * sizeof(unsigned int)));
